...
u_D=fe.Expression(("(t<1*pi)?(sin(t/1)*sin(t/1)*sin(t/1)*2):0","0"),t=0.0,degree=0)
...
#Archivo
fileU = fe.XDMFFile('ondaB/solution11U.xdmf')
fileE = fe.XDMFFile('ondaB/solution11E.xdmf')
fileS = fe.XDMFFile('ondaB/solution11S.xdmf')
